...
from communication.util.eva.exceptions import RequestRejected, SizeException, TimeoutException, \
    TransferCancelledException, TransferException, \
    TransferLimitException, ValueException
from communication.util.eva.payload import Acknowledgement, Data, Error, WriteRequest
from communication.util.eva.protocol import EVAProtocol
from communication.util.eva.result import TransferResult
from communication.util.eva.settings import EVASettings, Retransmission, Termination
...
async def eva():
    ...
    except RuntimeError:  # Loop can be closed already
        pass
